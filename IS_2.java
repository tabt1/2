...
int[] l = new int[n];
int[] r = new int[n];
for (int i = 0; i < l[i] r[i] = array[i + n];
}

int[] output = new int[2 * n];
for(
    int i = 0;i<n;output[i]=routput[i+n]=l[i];
}return output;}
...
for (int i = 0; i < 8System.out.print(plaintext[i] + " ");
...
System.out.println();
System.out.println("Your decrypted Text is :"); // printing the
// decrypted text
for (int i = 0; i < 8; i++)
